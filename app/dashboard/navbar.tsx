...
export function ComplexNavbar() {
  ...
  return (
    <Navbar className="mx-auto mt-2 border-0 p-1  text-sm font-medium lg:pl-2  border-inherit"  placeholder={undefined} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}>
